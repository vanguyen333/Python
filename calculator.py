...
class Calculator:
    def __ini__(self, master):
        ...
        Button(width=11,height=4, text=')',relief='flat',bg='white',command=lambda:self.show(')').placec(x= ,y=)
        Button(width=11,height=4, text='%',relief='flat',bg='white',command=lambda:self.show('%').placec(x= ,y=)
        Button(width=11,height=4, text='1',relief='flat',bg='white',command=lambda:self.show(1).placec(x= ,y=)
        Button(width=11,height=4, text='2',relief='flat',bg='white',command=lambda:self.show(2).placec(x= ,y=)
        Button(width=11,height=4, text='3',relief='flat',bg='white',command=lambda:self.show(3).placec(x= ,y=)
